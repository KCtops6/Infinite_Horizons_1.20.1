...
if (Platform.isLoaded('gtceu')) {
    // 1. Overworld Stone Gravel Sifting
    event.recipes.createsifterSifting([
        ...
        Item.of('gtceu:raw_gold').withChance(0.0031),
    ...
    ], ['kubejs:stone_gravel', 'kubejs:steel_mesh']).id('kubejs/recipes/createsiftersifting/steel/stone');

    // 2. Overworld Deepslate Gravel Sifting
    event.recipes.createsifterSifting([
    ...
    ], ['kubejs:deepslate_gravel', 'kubejs:steel_mesh']).id('kubejs/recipes/createsiftersifting/steel/deepslate');

    // 3. Netherrack Gravel Sifting
    event.recipes.createsifterSifting([
        ...
        Item.of('gtceu:raw_pyrite').withChance(0.0116),
        Item.of('gtceu:raw_redstone').withChance(0.0104),
        Item.of('gtceu:raw_blue_topaz').withChance(0.0091),
        Item.of('gtceu:raw_ruby').withChance(0.0070),
        Item.of('gtceu:raw_copper').withChance(0.0070),
        ...
        Item.of('gtceu:raw_chalcocite').withChance(0.0035),
        Item.of('gtceu:raw_saltpeter').withChance(0.0035),
        Item.of('gtceu:raw_diatomite').withChance(0.0035),
        ...
        Item.of('gtceu:raw_manganese').withChance(0.0026),
        ...
        Item.of('gtceu:raw_bornite').withChance(0.0012),
        Item.of('gtceu:raw_chert').withChance(0.0009),
    ...
    // 4. End Stone Gravel Sifting
    event.recipes.createsifterSifting([
        Item.of('gtceu:raw_naquadah').withChance(0.0281),
        Item.of('gtceu:raw_pitchblende').withChance(0.0281),
        Item.of('gtceu:raw_bauxite').withChance(0.0250),
        Item.of('gtceu:raw_magnetite').withChance(0.0141),
        Item.of('gtceu:raw_ilmenite').withChance(0.0125),
        Item.of('gtceu:raw_aluminium').withChance(0.0125),
        Item.of('gtceu:raw_scheelite').withChance(0.0125),
        Item.of('gtceu:raw_vanadium_magnetite').withChance(0.0094),
        ...
        Item.of('gtceu:raw_bornite').withChance(0.0047),
        Item.of('gtceu:raw_gold').withChance(0.0047),
