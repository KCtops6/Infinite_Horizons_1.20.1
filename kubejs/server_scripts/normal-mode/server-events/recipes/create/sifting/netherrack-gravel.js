ServerEvents.recipes(event => {
    ...
    ], ['infinite_horizons_tweaks:netherrack_gravel', 'createsifter:brass_mesh']).id('kubejs:recipes/createsiftersifting/brass/netherrack');
    event.recipes.createsifterSifting([
    ...
    ], ['infinite_horizons_tweaks:netherrack_gravel', 'kubejs:netherite_mesh']).id('kubejs:recipes/createsiftersifting/netherite/netherrack');
});