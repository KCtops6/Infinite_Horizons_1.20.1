ServerEvents.recipes(event => {
    event.recipes.createsifterSifting([
        ...
        Item.of('infinite_horizons_tweaks:stone_pebble').withChance(0.75),
        Item.of('infinite_horizons_tweaks:andesite_pebble').withChance(0.5),
        Item.of('infinite_horizons_tweaks:diorite_pebble').withChance(0.5),
        Item.of('infinite_horizons_tweaks:granite_pebble').withChance(0.5)
    ...
    event.recipes.createsifterSifting([
        ...
        Item.of('infinite_resources:raw_tin').withChance(0.5),
        Item.of('infinite_resources:raw_zinc').withChance(0.5),
    ...
    event.recipes.createsifterSifting([
        Item.of('gtceu:raw_chalcopyrite').withChance(0.25), // 314.375
        Item.of('gtceu:raw_cassiterite').withChance(0.2017892644),  // 253.75 0.2017892644
        Item.of('gtceu:raw_zeolite').withChance(0.0745526839),   // 93.75 0.0745526839
        Item.of('gtceu:raw_realgar').withChance(0.03727634195) // 46.875 0.03727634195
